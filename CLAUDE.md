...
- FW and BCF MUST be from the same SDK version (mixing causes crash)
...
- mDNS does not work (mmipal uses raw LWIP netif, not esp_netif)

## Working Test Results
```
FW: 1.13.1, morselib: 2.6.4-esp32, chip: 0x306
MAC: A8:DD:9F:4D:C6:01, RSSI: -37 dBm
